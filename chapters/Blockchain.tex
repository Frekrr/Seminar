...
Blockchain codiert sind.
\cite[p.~11f]{pirafelnerblockchaintechnologie}

% Hinzufügen neuer Transaktionen
Neue Transaktionen werden mittels eines Konsensalgorithmus hinzugefügt.
Hierfür wird zuerst ein Rechnerknoten ausgewählt, der den neuen Block berechnet. 
Da die Blockchain dezentral strukturiert ist, wird dies durch ein Zufallsprinzip entschieden.
% dezentral --> Verzicht auf Intermediäre
Hierfür wird ein kryptographisches Puzzle an alle 
% mehr Beschreibungen...
Zuletzt wird dieser neue Block von allen anderen Rechnerknoten validiert und in die 
Blockchain aufgenommen, sofern er fehlerfrei ist; ansonsten wird dieser verworfen.
\cite[p.~22ff]{fill2020blockchain}
